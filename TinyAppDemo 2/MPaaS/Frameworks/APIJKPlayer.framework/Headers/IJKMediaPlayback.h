...
// 注意，这里必须用宏的方式来定义
#ifndef IJKMPMediaPlaybackIsPreparedToPlayDidChangeNotification
    // Posted when the prepared state changes of an object conforming to the MPMediaPlayback protocol changes.
    // This supersedes MPMoviePlayerContentPreloadDidFinishNotification.
    #define IJKMPMediaPlaybackIsPreparedToPlayDidChangeNotification @"IJKMPMediaPlaybackIsPreparedToPlayDidChangeNotification"

    // Posted when movie playback ends or a user exits playback.
    #define IJKMPMoviePlayerPlaybackDidFinishNotification @"IJKMPMoviePlayerPlaybackDidFinishNotification"

     // NSNumber (IJKMPMovieFinishReason)
    #define IJKMPMoviePlayerPlaybackDidFinishReasonUserInfoKey @"IJKMPMoviePlayerPlaybackDidFinishReasonUserInfoKey"

    // Posted when the playback state changes, either programatically or by the user.
    #define IJKMPMoviePlayerPlaybackStateDidChangeNotification @"IJKMPMoviePlayerPlaybackStateDidChangeNotification"

    // Posted when the network load state changes.
    #define IJKMPMoviePlayerLoadStateDidChangeNotification @"IJKMPMoviePlayerLoadStateDidChangeNotification"

    // Posted when the movie player begins or ends playing video via AirPlay.
    #define IJKMPMoviePlayerIsAirPlayVideoActiveDidChangeNotification @"IJKMPMoviePlayerIsAirPlayVideoActiveDidChangeNotification"

    // Calling -prepareToPlay on the movie player will begin determining movie properties asynchronously.
    // These notifications are posted when the associated movie property becomes available.
    #define IJKMPMovieNaturalSizeAvailableNotification @"IJKMPMovieNaturalSizeAvailableNotification"

    #define IJKMPMoviePlayerVideoDecoderOpenNotification @"IJKMPMoviePlayerVideoDecoderOpenNotification"
    #define IJKMPMoviePlayerFirstVideoFrameRenderedNotification @"IJKMPMoviePlayerFirstVideoFrameRenderedNotification"
    #define IJKMPMoviePlayerFirstVideoFrameDidRenderToScreenNotification @"IJKMPMoviePlayerFirstVideoFrameDidRenderToScreenNotification"
    #define IJKMPMoviePlayerFirstAudioFrameRenderedNotification @"IJKMPMoviePlayerFirstAudioFrameRenderedNotification"
#endif
