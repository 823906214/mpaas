...
typedef NS_ENUM(NSInteger, AUDoubleTitleListItemStyle) {
    AUDoubleTitleListItemStyleDefault,  //有左图，高度是120，图标76 (单位:px)
    AUDoubleTitleListItemStyleValue1,  // 无左图，高度120，(单位:px)
    AUDoubleTitleListItemStyleValue2,  // 有左图，高度144，图标88 (单位:px)
};
