...
#define SINGLE_LEFT_IMAGE_SIZE                              AUI_THEME_SIZE(@"LIST_SINGLE_LINE_RIGHT_ASSIST_IMAGE_SIZE").width //左边图标默认正方形，大小为30
#define SINGLE_LEFT_IMAGE_SPACE                             AUI_THEME_FLOAT(@"LIST_LEFT_RIGHT_MARGIN") //16 //左图-主标题 间距
